...
const ForgotPassword = () => {
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/job_api/v1/auth/forgot-password/`,
        {
          method: "POST",
          headers: {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/job_api/v1/auth/reset-password/`,
        {
          method: "POST",
          headers: {
            accept: "application/json",
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep < 3 && (
              <motion.button
                ...
                className="w-full mt-6 bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200 font-medium flex items-center justify-center"
